...
public class QuanLy extends javax.swing.JFrame {
    ...
    private boolean kiemtraNullNV() {
        if (tfHoten.getText().equals("")) {
            ...
            return false;
        } else if (tfChucVu.getText().equals("")) {
...
//        ChonAnhMonAn();
//               JFileChooser chooser = new JFileChooser("C:\\Desktop\\DoAnTCFood\\src\\IMAGES");
...
//                congLaiSoLuong(maMonAn,soLuongBan);}
    ...
    private void tfSoLuongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfSoLuongActionPerformed
        ...
        tfThanhTien.setText("" + thanhTienMua);//tisnh tong Thanh Tien 
    ...
    private float tinhTongTien() {
        ...
        for (int i = 0; i < row; i++) {
            float ThanhTien = Float.parseFloat(tableHoaDon.getValueAt(i, 4).toString());//laasy 
            tongtien += ThanhTien;
        }
        return tongtien;
    }
    ...
    private boolean kiemtraNullKM() {
        if (tfTenKM.getText().equals("")) {
            ...
            return false;
        } else if (tfGiaKM.getText().equals("")) {
